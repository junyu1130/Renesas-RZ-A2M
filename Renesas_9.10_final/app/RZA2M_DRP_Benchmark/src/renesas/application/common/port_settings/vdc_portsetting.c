 ...
 * $Rev:  $
 * $Date: 2018-06-22T15:31:02+09:00 $
 ...
 ******************************************************************************/
static void RIIC_HdmiWrite( int_t handle, uint8_t ic_adr, uint8_t reg_adr_upper, uint8_t reg_adr_lower, uint8_t reg_data );
...
void VDC_LcdPortSetting(uint32_t param)
{
    ...
    */
    ...
    st_r_drv_gpio_pin_list_t pin_lcd;
    static const r_gpio_port_pin_t gs_lcd_pin_table[] =
    {
        GPIO_PORT_F_PIN_7,  GPIO_PORT_H_PIN_2,
        GPIO_PORT_F_PIN_6,  GPIO_PORT_F_PIN_5,
        GPIO_PORT_F_PIN_4,  GPIO_PORT_F_PIN_3,
        GPIO_PORT_F_PIN_2,  GPIO_PORT_F_PIN_1,
        GPIO_PORT_F_PIN_0,  GPIO_PORT_8_PIN_0,
        GPIO_PORT_A_PIN_0,  GPIO_PORT_A_PIN_1,
        GPIO_PORT_A_PIN_2,  GPIO_PORT_A_PIN_3,
        GPIO_PORT_A_PIN_4,  GPIO_PORT_A_PIN_5,
        GPIO_PORT_A_PIN_6,  GPIO_PORT_A_PIN_7,
        GPIO_PORT_B_PIN_0,  GPIO_PORT_B_PIN_1,
        GPIO_PORT_B_PIN_2,  GPIO_PORT_B_PIN_3,
        GPIO_PORT_B_PIN_4,  GPIO_PORT_B_PIN_5,
        GPIO_PORT_J_PIN_6,  GPIO_PORT_C_PIN_3,
        GPIO_PORT_C_PIN_4,  GPIO_PORT_7_PIN_7,
        GPIO_PORT_J_PIN_7
    };

    st_r_drv_gpio_sc_config_t pin_back_light;
    ...
    /* === LCD === */
    /* ---- Port initialize ---- */
    pin_lcd.p_pin_list = gs_lcd_pin_table;
    pin_lcd.count = (sizeof(gs_lcd_pin_table)) / (sizeof(gs_lcd_pin_table[0]));
    err = direct_control(gpio_handle, CTL_GPIO_INIT_BY_PIN_LIST, &pin_lcd);
    if ( err < 0 )
    {
        /* stop execute */
        while(1);
    ...
    /* === P7_6 : RSK LCD BACK Light === */
    /* ---- Port initialize ---- */
    pin_back_light.pin                    = GPIO_PORT_7_PIN_6;
    pin_back_light.configuration.function = GPIO_FUNC_OUT_LOW;
    pin_back_light.configuration.current  = GPIO_CURRENT_4mA;
    pin_back_light.configuration.tint     = GPIO_TINT_DISABLE;
...
#if ( LCD_PANEL==3 )
    {
        ...
        {
            /* HDMI On */
            senddata[0] = (uint8_t)(0x08u);
            senddata[1] = (uint8_t)(0xbfu);
            senddata[2] = (uint8_t)(0x70u);
            RIIC_HdmiWrite(
                    handle,
                    TFP410,
                    senddata[0],
