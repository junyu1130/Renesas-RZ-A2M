...
extern const st_mipi_reg_t g_mipi_reg_init_table[INIT_REG_NUM_MIPI] =
{
    /* Initialize */
        ...
        {0x01, 0x2A, 0x0C},
        {0x01, 0x2B, 0x00},
        /* frame length(height) = 2728 */
        /* line  length(width)  = 3448 */
		{0x01, 0x60, 0x0A},
		{0x01, 0x61, 0xA8},
		{0x01, 0x62, 0x0D},
		{0x01, 0x63, 0x78},

        /* X range (the coordinate before the binning) */
        {0x01, 0x64, 0x01},
        {0x01, 0x65, 0x7C},
        {0x01, 0x66, 0x0B},
        {0x01, 0x67, 0xFB},
        ...
        {0x01, 0x74, 0x01},  //x2 h binning
        {0x01, 0x75, 0x01},	 //x2 v binning
        {0x01, 0x76, 0x00},  //average h binning
        {0x01, 0x77, 0x00},  //average v binning
    ...
    /* Timing settings */
		...
		/* clock setting */
        {0x03, 0x01, 0x05},
        //{0x03, 0x04, 0x01}, /* Automatically */
        //{0x03, 0x05, 0x01}, /* Automatically */
        {0x03, 0x06, 0x00},
        {0x03, 0x07, 0x3A},
        {0x03, 0x09, 0x08},
        {0x03, 0x0C, 0x00},
