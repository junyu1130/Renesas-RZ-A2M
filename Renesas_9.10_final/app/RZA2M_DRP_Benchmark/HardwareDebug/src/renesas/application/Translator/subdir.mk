...
C_SRCS += \
../src/renesas/application/Translator/dnn_compute.c \
../src/renesas/application/Translator/network.c 

C_DEPS += \
./src/renesas/application/Translator/dnn_compute.d \
./src/renesas/application/Translator/network.d 

OBJS += \
./src/renesas/application/Translator/dnn_compute.o \
./src/renesas/application/Translator/network.o 


# Each subdirectory must supply rules for building sources it contributes
src/renesas/application/Translator/%.o: ../src/renesas/application/Translator/%.c
	@echo 'Building file: $<'
