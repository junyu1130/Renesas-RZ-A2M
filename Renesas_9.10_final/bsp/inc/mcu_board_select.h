...
/* Change the value accordingly to your Stream It version (1: Stream It 1.0 and 1.5 ; 2: Stream It 2.0) */
#define STREAM_IT_VERSION (2)
	
/* User Select macro, configure TARGET_DEVICE in project setting*/
