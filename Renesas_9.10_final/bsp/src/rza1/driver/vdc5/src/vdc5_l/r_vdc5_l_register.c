...
*******************************************************************************/
/**************************************************************************//**
* @file         r_vdc5_l_register.c
* @version      1.00
* $Rev: 99 $
* $Date:: 2017-04-10 20:56:26 +0900#$
* @brief        RZ/A1L VDC5 driver register setup processing
******************************************************************************/
...
#include    "r_vdc5_l_shared_param.h"
...
static void SetScalerBackgroundColor(const vdc5_color_space_t color_space);
...
static void SetImgQaImproverColorMtx(const vdc5_color_space_t color_space);

static void SetRwProcAbility_Write_0(const vdc5_onoff_t ability);
static void SetRwProcAbility_Read_0(const vdc5_onoff_t ability);
static void SetRwProcAbility_Read_2(const vdc5_onoff_t ability);
static void SetRwProcAbility_Read_3(const vdc5_onoff_t ability);
static void SetRegUpdateRwEnable(const vdc5_layer_id_t layer_id);

static void SetGraphicsDisplayMode(const vdc5_layer_id_t layer_id, const vdc5_gr_disp_sel_t * const gr_disp_sel);
...
static void (* const rw_proc_function_tbl[VDC5_LAYER_ID_NUM])(const vdc5_onoff_t ability) =
{
 ...
 * @retval      None
 *****************************************************************************/
void VDC5_Initialize (const vdc5_init_t * const param)
{
    ...
    {   /* Panel clock frequency division ratio */
        (uint16_t)VDC5_REG_CLKDIV_1_1,  (uint16_t)VDC5_REG_CLKDIV_1_2,
        (uint16_t)VDC5_REG_CLKDIV_1_3,  (uint16_t)VDC5_REG_CLKDIV_1_4,
        (uint16_t)VDC5_REG_CLKDIV_1_5,  (uint16_t)VDC5_REG_CLKDIV_1_6,
        (uint16_t)VDC5_REG_CLKDIV_1_7,  (uint16_t)VDC5_REG_CLKDIV_1_8,
        (uint16_t)VDC5_REG_CLKDIV_1_9,  (uint16_t)VDC5_REG_CLKDIV_1_12,
        (uint16_t)VDC5_REG_CLKDIV_1_16, (uint16_t)VDC5_REG_CLKDIV_1_24,
        (uint16_t)VDC5_REG_CLKDIV_1_32
    };
    static const uint16_t       panel_icksel_tbl[VDC5_PANEL_ICKSEL_NUM] =
    {   /* Panel clock select */
        (uint16_t)VDC5_REG_ICKSEL_IMG_DV, (uint16_t)VDC5_REG_ICKSEL_EXT_0, (uint16_t)VDC5_REG_ICKSEL_PERI
    };

    syscnt_panel_clk_reg = vdc5_regaddr_system_ctrl.syscnt_panel_clk;
    /* Disable */
    syscnt_panel_clk_tmp    = (uint16_t)((uint32_t)*syscnt_panel_clk_reg & (~VDC5_REG_BIT8));
    *syscnt_panel_clk_reg   = syscnt_panel_clk_tmp;

    inp_sel_cnt_reg = vdc5_regaddr_input_ctrl.inp_sel_cnt;
    /* Input select */
 ...
 * @retval      None
******************************************************************************/
void VDC5_SyncControl (const vdc5_sync_ctrl_t * const param)
{
    const vdc5_regaddr_scaler_t   * scaler_0;
    uint32_t                        full_scr;

    scaler_0    = &vdc5_regaddr_scaler;
 ...
 * @retval      None
******************************************************************************/
void VDC5_DisplayOutput (const vdc5_output_t * const param)
{
    ...
    output_ctrl = &vdc5_regaddr_output_ctrl;
    ...
    *(output_ctrl->out_pdtha) |= dither_format[param->out_format];
    ...
    SetGraphicsDisplayMode(VDC5_LAYER_ID_ALL, gr_disp_sel_tbl);
 ...
 * @retval      None
******************************************************************************/
void VDC5_WriteDataControl (const vdc5_write_t * const param)
{
    const vdc5_regaddr_scaler_t   * scaler;
    const vdc5_scalingdown_rot_t  * scldw_rot;

    scaler      = &vdc5_regaddr_scaler;
 ...
 * @retval      None
******************************************************************************/
void VDC5_ChangeWriteProcess (const vdc5_write_chg_t * const param)
{
    const vdc5_regaddr_scaler_t   * scaler;
    const vdc5_scalingdown_rot_t  * scldw_rot;
    ...
    *(scaler->scl0_ds7) |= (uint32_t)scldw_rot->res_out_hw;
    ...
    res_inter_tmp = VDC5_ShrdPrmGetInterlace();
    /* Scaling-down */
 ...
 * @retval      None
******************************************************************************/
void VDC5_ReadDataControl (const vdc5_graphics_type_t graphics_id, const vdc5_read_t * const param)
{
    ...
    w_read_fb = VDC5_ShrdPrmGetFrBuffWidth_Rd(graphics_id);
    ...
    img_synthesizer = &vdc5_regaddr_img_synthesizer[graphics_id];
    ...
    *(img_synthesizer->gr_ab3) |= (uint32_t)param->gr_grc.hw;
    ...
    if ((graphics_id == VDC5_GR_TYPE_GR2) || (graphics_id == VDC5_GR_TYPE_GR3))
    {
    ...
    *(img_synthesizer->gr_ab7) &= (uint32_t)~VDC5_REG_BIT0;
    ...
    {   /* Alpha value is set to 255. */
        ...
        *(img_synthesizer->gr_flm6) &= (uint32_t)~VDC5_REG_MASK_0X0000E000;
        ...
        img_qlty_imp = &vdc5_regaddr_img_qlty_imp;
        /* Operating mode */
 ...
 * @retval      None
******************************************************************************/
void VDC5_ChangeReadProcess (const vdc5_graphics_type_t graphics_id, const vdc5_read_chg_t * const param)
{
    const vdc5_regaddr_img_synthesizer_t  * img_synthesizer;
    ...
    gr_flm_sel_tmp  = VDC5_ShrdPrmGetSelFbAddrSig(graphics_id);
    gr_grc_tmp      = VDC5_ShrdPrmGetDisplayArea(graphics_id);
    w_read_fb       = VDC5_ShrdPrmGetFrBuffWidth_Rd(graphics_id);
    ...
    if (param->gr_base != NULL)
    {
        *(img_synthesizer->gr_flm2) = (uint32_t)param->gr_base & (uint32_t)~VDC5_REG_MASK_0X00000007;
        ...
        {
            gr_format_tmp = VDC5_ShrdPrmGetGraphicsFormat(graphics_id);
            /* Sets the amount of data to be skipped through */
 ...
 * @retval      None
******************************************************************************/
void VDC5_StartProcess (const vdc5_layer_id_t layer_id, const vdc5_start_t * const param)
{
    ...
    {
        rw_proc_function_tbl[layer_id](VDC5_ON);
    }
    else
    {
        for (layer_id_num = 0; layer_id_num < (uint32_t)VDC5_LAYER_ID_NUM; layer_id_num++)
        {
            resource_state = VDC5_ShrdPrmGetRwProcReady((vdc5_layer_id_t)layer_id_num);
            if (resource_state != VDC5_RESOURCE_ST_INVALID)
            {
                rw_proc_function_tbl[layer_id_num](VDC5_ON);
            }
        }
    }
 ...
 * @retval      None
******************************************************************************/
void VDC5_StopProcess (const vdc5_layer_id_t layer_id)
{
    uint32_t                    layer_id_num;
    vdc5_resource_state_t       resource_state;
    ...
    if (layer_id != VDC5_LAYER_ID_ALL)
    {
        rw_proc_function_tbl[layer_id](VDC5_OFF);
    }
    else
    {
        for (layer_id_num = 0; layer_id_num < (uint32_t)VDC5_LAYER_ID_NUM; layer_id_num++)
        {
            resource_state = VDC5_ShrdPrmGetRwProcEnabled((vdc5_layer_id_t)layer_id_num);
            if (resource_state != VDC5_RESOURCE_ST_INVALID)
            {
                rw_proc_function_tbl[layer_id_num](VDC5_OFF);
            }
        }
    }
    SetRegUpdateRwEnable(layer_id);
 ...
 * @retval      None
******************************************************************************/
void VDC5_VideoNoiseReduction (const vdc5_onoff_t nr1d_on, const vdc5_noise_reduction_t * const param)
{
    const vdc5_regaddr_input_ctrl_t   * input_ctrl;
 ...
 * @retval      None
******************************************************************************/
void VDC5_ImageColorMatrix (const vdc5_color_matrix_t * const param)
{
    SetColorMatrix(param->mtx_mode, param->offset, param->gain, &vdc5_regaddr_color_matrix[param->module]);
 ...
 * @retval      None
******************************************************************************/
void VDC5_AlphaBlending (const vdc5_graphics_type_t graphics_id, const vdc5_alpha_blending_t * const param)
{
    const vdc5_regaddr_img_synthesizer_t  * img_synthesizer;
...
}   /* End of function VDC5_AlphaBlendingRect() */
 ...
 * @retval      None
******************************************************************************/
void VDC5_CLUT (const vdc5_graphics_type_t graphics_id, const vdc5_clut_t * const param)
{
    vdc5_gr_format_t                        gr_format_tmp;
    const vdc5_regaddr_img_synthesizer_t  * img_synthesizer;
    ...
    {
        Set_Clut(param, vdc5_regaddr_clut[graphics_id]);
 ...
 * @retval      None
******************************************************************************/
void VDC5_DisplayCalibration (const vdc5_disp_calibration_t * const param)
{
 ...
 * @retval      None
******************************************************************************/
void VDC5_GammaCorrection (const vdc5_onoff_t gam_on, const vdc5_gamma_correction_t * const param)
{
    const vdc5_regaddr_gamma_t  * gamma;

    gamma = &vdc5_regaddr_gamma;
...
static void SetInitialConnection (void)
{
    ...
    vin_gr_update   = &VDC50.GR_VIN_UPDATE;
    vin_gr_ab1      = &VDC50.GR_VIN_AB1;

    /* Selection of lower-layer plane in scaler: Selects graphics 0 as lower-layer graphics. */
    *(vin_gr_ab1)  &= (uint32_t)~VDC5_REG_BIT2;
    /* Graphics display mode in VIN */
    *(vin_gr_ab1)  &= (uint32_t)~VDC5_REG_MASK_0X00000003;
    *(vin_gr_ab1)  |= (uint32_t)VDC5_DISPSEL_LOWER;
    /* Graphics register update control register (GR_VIN_UPDATE)
       b8       GR_VIN_UPDATE
       b4       GR_VIN_P_VEN */
    *(vin_gr_update) |= (uint32_t)(VDC5_REG_BIT8|VDC5_REG_BIT4);
...
static void SetGrapicsBackgroundColor (void)
{
    ...
    bg_color_tmp = VDC5_ShrdPrmGetBgColor(VDC5_COLOR_SPACE_GBR);
    ...
    bg_color_reg    = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR2].gr_base;
    *bg_color_reg   = bg_color_conv;
    /* Graphics register update control register (GR2_UPDATE)
       b4       GR2_P_VEN */
    update_reg      = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR2].gr_update;
    *update_reg    |= (uint32_t)VDC5_REG_BIT4;

    /* Background color in GBR format (GR3_BASE) */
    bg_color_reg    = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR3].gr_base;
    *bg_color_reg   = bg_color_conv;
    /* Graphics register update control register (GR3_UPDATE)
       b4       GR3_P_VEN */
    update_reg      = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR3].gr_update;
    *update_reg    |= (uint32_t)VDC5_REG_BIT4;
...
static void SetScalerBackgroundColor (const vdc5_color_space_t color_space)
{
    ...
    scl0_ovr1_reg   = vdc5_regaddr_scaler.scl0_ovr1;
    scl0_update_reg = vdc5_regaddr_scaler.scl0_update;
    gr_base_reg     = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR0].gr_base;
    gr_update_reg   = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR0].gr_update;

    /* Background color in 24-bit RGB color format or CrYCb format */
    bg_color_tmp    = VDC5_ShrdPrmGetBgColor(color_space);
    /* Conversion from RGB into GBR / from CrYCb into YCbCr */
    bg_color_conv   = ColorConversionIntoAgbr(bg_color_tmp);
    bg_color_conv  &= (uint32_t)VDC5_REG_RGB_24BIT_MASK;
...
static void SetInputCntrlColorMtx (void)
{
    ...
    color_space_input   = VDC5_ShrdPrmGetColorSpace();
    color_space_fb      = VDC5_ShrdPrmGetColorSpaceFbWr();
    ...
    SetColorMatrix(mtx_mode_tmp, offset_tmp, gain_tmp, &vdc5_regaddr_color_matrix[VDC5_COLORMTX_IMGCNT]);
    ...
    const vdc5_onoff_t                  gr_enlarge)
{
    ...
    {   /* Video image or graphics enlargement */
        ...
        *(scaler->scl0_us4) |= (uint32_t)w_read_fb->in_hw;
        ...
        res_ds_wr_md_tmp    = VDC5_ShrdPrmGetWritingMode();
        adj_sel_tmp         = VDC5_ShrdPrmGetMeasureFolding(graphics_id);
        ...
        ln_off_dir = VDC5_ShrdPrmGetLineOfsAddrDir(graphics_id);
        /* Scaling-up */
...
static void SetImgQaImproverColorMtx (const vdc5_color_space_t color_space)
{
    ...
    SetColorMatrix(mtx_mode_tmp, offset_tmp, gain_tmp, &vdc5_regaddr_color_matrix[VDC5_COLORMTX_ADJ_0]);
...
static void SetRwProcAbility_Write_0 (const vdc5_onoff_t ability)
{
    ...
    {   /* SC0 frame buffer writing is disabled */
        *(scaler->scl1_wr5) &= (uint32_t)~VDC5_REG_BIT0;
        ...
        VDC5_ShrdPrmSetRwProcDisable(VDC5_LAYER_ID_0_WR);
    }
    else
...
static void SetRwProcAbility_Read_0 (const vdc5_onoff_t ability)
{
    ...
    /* SC0/GR0 reading */
    img_synthesizer = &vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR0];
    ...
    {   /* GR0 frame buffer reading is disabled */
        ...
        *(img_synthesizer->gr_ab1) |= (uint32_t)VDC5_DISPSEL_BACK;
        ...
        VDC5_ShrdPrmSetRwProcDisable(VDC5_LAYER_ID_0_RD);
    }
    else
    {   /* GR0 frame buffer reading is enabled */
        *(img_synthesizer->gr_flm_rd) |= (uint32_t)VDC5_REG_BIT0;

        VDC5_ShrdPrmSetRwProcEnable(VDC5_LAYER_ID_0_RD);
    }
...
static void SetRwProcAbility_Read_2 (const vdc5_onoff_t ability)
{
    ...
    /* GR2 reading */
    img_synthesizer = &vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR2];
    ...
    {   /* GR2 frame buffer reading is disabled */
        ...
        *(img_synthesizer->gr_ab1) |= (uint32_t)VDC5_DISPSEL_LOWER;
        ...
        VDC5_ShrdPrmSetRwProcDisable(VDC5_LAYER_ID_2_RD);
    }
    else
    {   /* GR2 frame buffer reading is enabled */
        *(img_synthesizer->gr_flm_rd) |= (uint32_t)VDC5_REG_BIT0;

        VDC5_ShrdPrmSetRwProcEnable(VDC5_LAYER_ID_2_RD);
    }
...
static void SetRwProcAbility_Read_3 (const vdc5_onoff_t ability)
{
    ...
    /* GR3 reading */
    img_synthesizer = &vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR3];
    ...
    {   /* GR3 frame buffer reading is disabled */
        ...
        *(img_synthesizer->gr_ab1) |= (uint32_t)VDC5_DISPSEL_LOWER;
        ...
        VDC5_ShrdPrmSetRwProcDisable(VDC5_LAYER_ID_3_RD);
    }
    else
    {   /* GR3 frame buffer reading is enabled */
        *(img_synthesizer->gr_flm_rd) |= (uint32_t)VDC5_REG_BIT0;

        VDC5_ShrdPrmSetRwProcEnable(VDC5_LAYER_ID_3_RD);
    }
...
static void SetRegUpdateRwEnable (const vdc5_layer_id_t layer_id)
{
    ...
    switch (layer_id)
    {
        case VDC5_LAYER_ID_0_WR:        /* Layer 0, write process */
            scl1_update_reg   = vdc5_regaddr_scaler.scl1_update;
        ...
        case VDC5_LAYER_ID_2_RD:        /* Layer 2, read process */
            gr_update_reg   = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR2].gr_update;
            *gr_update_reg |= (uint32_t)(VDC5_REG_BIT4|VDC5_REG_BIT0);
        break;
        case VDC5_LAYER_ID_3_RD:        /* Layer 3, read process */
            gr_update_reg   = vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_GR3].gr_update;
            *gr_update_reg |= (uint32_t)(VDC5_REG_BIT4|VDC5_REG_BIT0);
        break;
...
static void SetGraphicsDisplayMode (const vdc5_layer_id_t layer_id, const vdc5_gr_disp_sel_t * const gr_disp_sel)
{
    ...
    if (layer_id == VDC5_LAYER_ID_ALL)
    {
        ...
        {
            if (gr_disp_sel[graphics_id] != VDC5_DISPSEL_IGNORED)
            {
                img_synthesizer = &vdc5_regaddr_img_synthesizer[graphics_id];
    ...
    else if ((layer_id == VDC5_LAYER_ID_0_RD) || (layer_id == VDC5_LAYER_ID_2_RD) || (layer_id == VDC5_LAYER_ID_3_RD))
    {
