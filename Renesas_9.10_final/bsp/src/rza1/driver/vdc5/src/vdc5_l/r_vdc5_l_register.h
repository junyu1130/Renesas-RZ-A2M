...
*******************************************************************************/
/**************************************************************************//**
* @file         r_vdc5_l_register.h
* @version      1.00
* $Rev: 99 $
* $Date:: 2017-04-10 20:56:26 +0900#$
* @brief        RZ/A1L VDC5 driver register setup definitions
******************************************************************************/
...
Variable Externs
******************************************************************************/
extern const vdc5_regaddr_input_ctrl_t      vdc5_regaddr_input_ctrl;
extern const vdc5_regaddr_scaler_t          vdc5_regaddr_scaler;
extern const vdc5_regaddr_img_qlty_imp_t    vdc5_regaddr_img_qlty_imp;
extern const vdc5_regaddr_color_matrix_t    vdc5_regaddr_color_matrix[VDC5_COLORMTX_NUM];
extern const vdc5_regaddr_img_synthesizer_t vdc5_regaddr_img_synthesizer[VDC5_GR_TYPE_NUM];
extern uint32_t                     * const vdc5_regaddr_clut[VDC5_GR_TYPE_NUM];
extern const vdc5_regaddr_output_ctrl_t     vdc5_regaddr_output_ctrl;
extern const vdc5_regaddr_gamma_t           vdc5_regaddr_gamma;
extern const vdc5_regaddr_system_ctrl_t     vdc5_regaddr_system_ctrl;
