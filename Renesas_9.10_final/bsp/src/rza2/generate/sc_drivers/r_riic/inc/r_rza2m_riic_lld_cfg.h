 ...
 *******************************************************************************/
/*******************************************************************************
 * @headerfile     r_rza2_riic_lld_cfg.h
 * @brief          RIIC low level driver cfg header
 * @version        1.00
 * @date           15.05.2018
 * H/W Platform    RZ/A2M
 *******************************************************************************/
...
#ifndef R_RIIC_INC_R_RZA2_RIIC_LLD_CFG_H_
    #define R_RIIC_INC_R_RZA2_RIIC_LLD_CFG_H_
...
#endif /* SRC_RENESAS_AUTOMATED_TEST_R_RIIC_INC_R_RZA2_RIIC_LLD_CFG_H_ */
