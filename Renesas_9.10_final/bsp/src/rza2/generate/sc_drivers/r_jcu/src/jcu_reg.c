...
* - $Rev: $
* - $Date: 2018-11-28T17:26:44+09:00 $
******************************************************************************/
...
void JCU_SetRegisterForCodec( const jcu_codec_t  codec )
{
	...
	while ( R_STB_RequestModuleStop( MODULE_JCU ) == STB_AGAIN )
		{ }
	R_BIT_SET_IN_REGISTER8( CPG,SWRSTCR2,SRST21,  1 );
	dummy_read = R_BIT_GET_IN_REGISTER8( CPG,SWRSTCR2,SRST21 );
		R_UNREFERENCED_VARIABLE( dummy_read );

	R_BIT_SET_IN_REGISTER8( CPG,SWRSTCR2,SRST21,  0 );
	dummy_read = R_BIT_GET_IN_REGISTER8( CPG,SWRSTCR2,SRST21 );
		R_UNREFERENCED_VARIABLE( dummy_read );
	...
	const jcu_continue_type_t  type)
{
	...
	jcu_internal_information_t* const  self = R_JCU_GetInternalInformation();
		...
		if ( self == NULL ) { e=JCU_ERROR_PARAM_2A; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	const jcu_buffer_param_t   *const buffer)
{
	...
	#if ! defined( JCU_RELEASE )
		if ( decode == NULL ) { e=JCU_ERROR_PARAM_2B; goto fin; } /* Error: <Parameter/> */
		if ( buffer == NULL ) { e=JCU_ERROR_PARAM_2C; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	const uint8_t* const   table)
{
	...
	#if ! defined( JCU_RELEASE )
		if ( tableAtRegister == NULL ) { e=JCU_ERROR_PARAM_2D; goto fin; } /* Error: <Parameter/> */
		if ( table == NULL ) { e=JCU_ERROR_PARAM_2E; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	const uint8_t *const   table)
{
	...
	#if ! defined( JCU_RELEASE )
		if ( tableAtRegister == NULL ) { e=JCU_ERROR_PARAM_2F; goto fin; } /* Error: <Parameter/> */
		if ( table == NULL ) { e=JCU_ERROR_PARAM_30; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	const jcu_buffer_param_t   *const buffer)
{
	...
	#if ! defined( JCU_RELEASE )
		if ( encode == NULL ) { e=JCU_ERROR_PARAM_31; goto fin; } /* Error: <Parameter/> */
		if ( buffer == NULL ) { e=JCU_ERROR_PARAM_32; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	jcu_image_info_t *const buffer)
{
	...
	#if ! defined( JCU_RELEASE )
		if ( buffer == NULL ) { e=JCU_ERROR_PARAM_33; goto fin; } /* Error: <Parameter/> */
	#endif
