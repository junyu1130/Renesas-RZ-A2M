...
* - $Rev: $
* - $Date: 2018-11-28T14:23:50+09:00 $
******************************************************************************/
...
/* <-SEC M1.1.1 */
{
	...
	if (!( self->AsyncStatus.Status == JCU_STATUS_UNDEF )) {
		e = JCU_ERROR_STATUS_1;  goto fin;  /* Error: Already initialized. */
	}
	...
	e= R_JCU_OnInitialize(); if(e){goto fin;}

	/* Set the register */
	e= JCU_SetRegisterForInitialize(); if(e){goto fin;}
...
/* <-SEC M1.1.1 */
{
	...
	int_fast32_t  oblivious = 0;
		...
		if ( in_OnFinalized == NULL ) { e = JCU_ERROR_PARAM_1;  goto fin; }  /* Error: <Parameter/> */
	#endif
	...
	if ( oblivious != 0 ) { e=E_JCU_OBLIVIOUS_3; goto fin; }  /* Error: */
	e=0;
fin:
	if ( was_enabled ) {
...
jcu_errorcode_t  R_JCU_FinalizeStep2_Sub(void)
{
	...
	e= R_JCU_OnFinalize(); if(e){goto fin;}
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			...
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_2;  goto fin; }  /* Error: <State/> */
...
/* <-SEC M1.1.1 */
{
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		e= JCU_ParaCheckStart(); if(e){goto fin;}
	#endif
...
/* <-SEC M1.1.1 */
{
	...
	e= self->AsyncStatus.ReturnValue; if(e){goto fin;}
...
/* <-SEC M1.1.1 */
{
	...
	switch ( in_Type )
	{
		...
		case JCU_OUTPUT_BUFFER:
			...
			break;
		default:
			if (!( in_Type == JCU_IMAGE_INFO )) { e=JCU_ERROR_PARAM_4; goto fin; }  /* Error: <Parameter/> */
			mask = JCU_JINTS0_INS3;
			break;
	}
	if (!( IS_ANY_BITS_SET( self->AsyncStatus.SubStatusFlags, mask ) ))
		{ e=JCU_ERROR_PARAM_5; goto fin; }  /* Error: <Parameter/> */
...
/* <-SEC M1.1.1 */
{
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_6;  goto fin; }  /* Error: <State/> */
		if (!(
			self->Codec == JCU_STATUS_DECODE ))
				{ e = JCU_ERROR_STATUS_7;  goto fin; }  /* Error: <State/> */

		if (!( in_Decode != NULL ))
			{ e = JCU_ERROR_PARAM_6;  goto fin; }  /* Error: <Parameter/> */

		if (! (in_Buffer != NULL ))
			{ e = JCU_ERROR_PARAM_7;  goto fin; }  /* Error: <Parameter/> */

		e = JCU_ParaCheckSetDecodeParam(in_Decode, in_Buffer); if(e){goto fin;}
	#endif
...
static jcu_errorcode_t R_JCU_SetPauseForImageInfo_ST( const bool_t  in_IsPause )
{
	...
	jcu_internal_information_t* const  self = &gs_jcu_internal_information;
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_16;  goto fin; }  /* Error: Not called "R_JCU_SelectCodec" yet */
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_8;  goto fin; }  /* Error: <State/> */
		if (!(
			self->Codec == JCU_STATUS_DECODE ))
				{ e = JCU_ERROR_STATUS_9;  goto fin; }  /* Error: <State/> */
	#endif
...
/* <-SEC M1.1.1 */
{
	...
	#if  ! defined( JCU_RELEASE )
		if (!( self->AsyncStatus.Status == JCU_STATUS_READY ))
			{ e = JCU_ERROR_STATUS_A;  goto fin; }  /* Error: <State/> */

		if (!( self->Codec == JCU_STATUS_DECODE ))
			{ e = JCU_ERROR_STATUS_B;  goto fin; }  /* Error: <State/> */

		if (!( out_Buffer != NULL ))
			{ e = JCU_ERROR_PARAM_8;  goto fin; }  /* Error: <Parameter/> */

		e = JCU_ParaCheckGetImageInfo( out_Buffer ); if(e){goto fin;}
	#endif
...
static jcu_errorcode_t  R_JCU_SetErrorFilter_ST( jcu_int_detail_errors_t  in_Filter )
{
	...
	jcu_internal_information_t* const  self = &gs_jcu_internal_information;
		...
		if (!(
			...
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_C;  goto fin; }  /* Error: <State/> */
	#endif

	if ( IS_ANY_BITS_SET( in_Filter, (bit_flags_fast32_t) ~JCU_INT_ERROR_ALL ) )
		{ e = JCU_ERROR_PARAM_9; goto fin; }  /* Error: <Parameter/> */
...
/* <-SEC M1.1.1 */
{
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_D;  goto fin; }  /* Error: <State/> */
		if (!(
			self->Codec == JCU_STATUS_ENCODE ))
				{ e = JCU_ERROR_STATUS_E;  goto fin; }  /* Error: <State/> */

		if (!( in_Table != NULL ))
			{ e = JCU_ERROR_PARAM_A;  goto fin; }  /* Error: <Parameter/> */
	#endif
...
/* <-SEC M1.1.1 */
{
	...
	#if  ! defined( JCU_RELEASE )
		e= JCU_ParaCheckSetHuffmanTable( in_TableNum,  in_Type ); if(e){goto fin;}
	#endif
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_F;  goto fin; }  /* Error: <State/> */
		if (!(
			self->Codec == JCU_STATUS_ENCODE ))
				{ e = JCU_ERROR_STATUS_10;  goto fin; }  /* Error: <State/> */

		if (!( in_Table != NULL ))
			{ e = JCU_ERROR_PARAM_B;  goto fin; }  /* Error: <Parameter/> */
	#endif
...
/* <-SEC M1.1.1 */
{
	...
	was_enabled = R_JCU_DisableInterrupt();
		...
		if (!(
			self->AsyncStatus.Status == JCU_STATUS_SELECTED  ||
			self->AsyncStatus.Status == JCU_STATUS_READY ))
				{ e = JCU_ERROR_STATUS_11;  goto fin; }  /* Error: <State/> */
		if (!(
			self->Codec == JCU_STATUS_ENCODE ))
				{ e = JCU_ERROR_STATUS_12;  goto fin; }  /* Error: <State/> */

		if (!( in_Encode != NULL ))
			{ e = JCU_ERROR_PARAM_C;  goto fin; }  /* Error: <Parameter/> */

		if (!( in_Buffer != NULL ))
			{ e = JCU_ERROR_PARAM_D;  goto fin; }  /* Error: <Parameter/> */

		e= JCU_ParaCheckEncodeParam( in_Encode,  in_Buffer ); if(e){goto fin;}
	#endif
...
/* <-SEC M1.1.1 */
{
	...
	#if  ! defined( JCU_RELEASE )
	{
		...
		if (!( self->AsyncStatus.Status == JCU_STATUS_READY ))
			{ e = JCU_ERROR_STATUS_13; goto fin; }  /* Error: <State/> */
	}
	#endif
...
errnum_t  R_JCU_OnInterrupting()
{
	...
	#if  ! defined( JCU_RELEASE )
		if ( self == NULL ) { e=JCU_ERROR_PARAM_26; goto fin; } /* Error: <Parameter/> */
	#endif
...
static errnum_t  R_JCU_OnInterrupted(void)
{
	...
	#if  ! defined( JCU_RELEASE )
		if ( self == NULL ) { e=JCU_ERROR_PARAM_27; goto fin; } /* Error: <Parameter/> */
	#endif
	...
	if (!( self->AsyncStatus.Status != JCU_STATUS_UNDEF )) { e=E_STATE; goto fin; }  /* Error: <State/> */
	...
	if (!or) { or = IS_BIT_SET( interrupt_flags,  JCU_JINTS0_INS5 ); }  /* or = for MISRA 12.4 */
	if ( or )
	{
		/* Set "AsyncStatus" */
		self->AsyncStatus.Status = JCU_STATUS_READY;
	...
	if ( is_callback_1 ) {
		if ( IS_BIT_SET( self->AsyncStatus.CancelFlags,  JCU_FINALIZE_REQUEST ) ) {
			is_callback_2 = true;
			ee= R_JCU_FinalizeStep2_Sub(); if(e==0){e=ee;}
		}
	}
