...
*    Common Types.
*
* - $ModuleRevision: {Masters}\OSPL\_Set\200_15_Co_RZA2 $
* - $Rev: $
* - $Date: 2018-09-05T10:43:24+09:00 $
************************************************************************/
...
#define  R_STATIC_ASSERT( ConstantExpression, StringLiteral ) \
	R_STATIC_ASSERT_SUB( ConstantExpression, StringLiteral )
#else
#define  R_STATIC_ASSERT( ConstantExpression, StringLiteral ) \
	_Pragma(R_PRAGMA_STRINGIFY(GCC diagnostic ignored "-Wunused-local-typedefs")) \
	R_STATIC_ASSERT_SUB( ConstantExpression, StringLiteral )
#endif
...
#define  R_STATIC_ASSERT_GLOBAL( ConstantExpression, StringLiteral ) \
	R_STATIC_ASSERT_GLOBAL_SUB( ConstantExpression, StringLiteral )
#else
#define  R_STATIC_ASSERT_GLOBAL( ConstantExpression, StringLiteral ) \
	_Pragma(R_PRAGMA_STRINGIFY(GCC diagnostic ignored "-Wunused-local-typedefs")) \
	R_STATIC_ASSERT_GLOBAL_SUB( ConstantExpression, StringLiteral )
