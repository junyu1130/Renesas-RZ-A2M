...
usbh1_er_t usbh1_hstd_rtos_snd_msg (uint8_t id, usb_msg_t* mess);
usbh1_er_t usbh1_hstd_rtos_rec_msg (uint8_t id, usb_msg_t** mess, usbh1_tm_t tm);
...
//  err = xQueueReceive(handle, (void *)mess, (TickType_t)(tm));
    while( 0 == xQueueReceive(handle, (void *)mess, (TickType_t)(tm)) ){}
