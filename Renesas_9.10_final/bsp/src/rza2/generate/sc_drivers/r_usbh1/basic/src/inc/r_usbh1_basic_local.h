...
typedef void*   H1VP;         /* Pointer to variable      */
typedef short   H1ID;         /* Object ID (xxxid)        */
typedef long    H1TMO;        /* Time out                 */
typedef long    H1VP_INT;     /* Integer data             */

/*----------- msghead -----------*/
typedef struct
{
    H1VP msghead; /* Message header */
} t_usbh1_msg_t;

typedef t_usbh1_msg_t     usb_msg_t;
typedef H1ID              usbh1_id_t;
typedef H1TMO             usbh1_tm_t;
typedef H1VP              usbh1_mh_t;
typedef H1VP_INT          usbh1_vp_int_t;
