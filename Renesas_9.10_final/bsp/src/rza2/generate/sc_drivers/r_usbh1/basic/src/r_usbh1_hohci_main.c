...
void usbh1_hstd_ohci_interrupt_handler(void)
{
    ...
    usbh1_hstd_hci_send_message_from_int(USBH1_HCI_TASK, USBH1_HCI_MESS_OHCI_INT, context_info);
...
***********************************************************************************************************************/
void usbh1_hstd_OhciMainRoutine(uint32_t context_info)
{
    uint32_t                        temp;
    uint32_t                        temp2;
    uint32_t                        frame;
    ...
    if (context_info & USBH1_OHCI_IS_ROOTHUBSTATUSCHANGE)
    {
        ...
        usbh1_hstd_ohci_control_roothub();
 ...
 * Note         :
***********************************************************************************************************************/
void usbh1_hstd_ohci_control_roothub(void)
{
    uint32_t    portnum;
    uint32_t    numports;
