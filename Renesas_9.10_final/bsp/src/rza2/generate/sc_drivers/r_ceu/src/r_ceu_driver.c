...
ceu_error_t R_CEU_Open(const ceu_config_t * const config)
{
    ...
    if (CEU_OK == error)
    {
        ...
        CEU.CAMCR.LONG = (uint32_t) ((((((CAMCR_FLDPOL_VALUE << CEU_SHIFT_VALUE_16) | /* */
                         (uint32_t)(config->dtif  << 12u)) |                          /* */
                         (uint32_t)(config->dtary <<  8u)) |                          /* */
                         (uint32_t)(config->jpg   <<  4u)) |                          /* */
                         (uint32_t)(config->vdpol <<  1u)) |                          /* */
                         (uint32_t)(config->hdpol <<  0u));                           /* */
         ...
         */
        /* This implicit casting is valid because unsigned long is acceptable the value */
        CEU.CDOCR_A.LONG = (uint32_t) (((((CDOCR_CBE_VALUE << CEU_SHIFT_VALUE_16) | (CDOCR_CDS_VALUE << CEU_SHIFT_VALUE_4)) | /* */
                           (uint32_t) (config->cols << CEU_SHIFT_VALUE_2)) | /* */
                           (uint32_t) (config->cows << CEU_SHIFT_VALUE_1)) | /* */
